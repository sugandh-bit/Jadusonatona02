...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Mr_Rocky_Tz")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/ROCKY_UPDATE")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/ROCKY_SUPPORTB")
